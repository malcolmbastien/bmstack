...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field companies on 'Project'
        db.create_table('projects_project_companies', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm['projects.project'], null=False)),
            ('company', models.ForeignKey(orm['projects.company'], null=False))
        ))
        db.create_unique('projects_project_companies', ['project_id', 'company_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field companies on 'Project'
        db.delete_table('projects_project_companies')
