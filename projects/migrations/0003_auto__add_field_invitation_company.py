...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invitation.company'
        db.add_column('projects_invitation', 'company', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['projects.Company']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invitation.company'
        db.delete_column('projects_invitation', 'company_id')
