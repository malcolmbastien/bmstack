...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CanvasSet.private'
        db.delete_column('projects_canvasset', 'private')

        # Adding field 'CanvasSet.private_canvas'
        db.add_column('projects_canvasset', 'private_canvas', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Update.private'
        db.delete_column('projects_update', 'private')

        # Adding field 'Update.private_update'
        db.add_column('projects_update', 'private_update', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'CanvasSet.private'
        db.add_column('projects_canvasset', 'private', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'CanvasSet.private_canvas'
        db.delete_column('projects_canvasset', 'private_canvas')

        # Adding field 'Update.private'
        db.add_column('projects_update', 'private', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Update.private_update'
        db.delete_column('projects_update', 'private_update')
    ...
    models = {
        ...
        'projects.canvasset': {
            ...
            'private_canvas': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['projects.Project']"})
        },
        'projects.company': {
        ...
        'projects.update': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'private_update': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['projects.Project']"}),
