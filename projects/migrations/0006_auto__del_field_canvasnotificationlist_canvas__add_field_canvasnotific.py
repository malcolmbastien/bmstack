...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CanvasNotificationList.canvas'
        db.delete_column('projects_canvasnotificationlist', 'canvas_id')

        # Adding field 'CanvasNotificationList.canvas_set'
        db.add_column('projects_canvasnotificationlist', 'canvas_set', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['projects.CanvasSet']), keep_default=False)


    def backwards(self, orm):
        
        # We cannot add back in field 'CanvasNotificationList.canvas'
        raise RuntimeError(
            "Cannot reverse this migration. 'CanvasNotificationList.canvas' and its values cannot be restored.")

        # Deleting field 'CanvasNotificationList.canvas_set'
        db.delete_column('projects_canvasnotificationlist', 'canvas_set_id')
