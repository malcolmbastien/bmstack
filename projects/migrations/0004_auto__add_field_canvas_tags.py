...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Canvas.tags'
        db.add_column('projects_canvas', 'tags', self.gf('tagging.fields.TagField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Canvas.tags'
        db.delete_column('projects_canvas', 'tags')
