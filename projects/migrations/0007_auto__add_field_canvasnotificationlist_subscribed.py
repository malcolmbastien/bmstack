...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CanvasNotificationList.subscribed'
        db.add_column('projects_canvasnotificationlist', 'subscribed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CanvasNotificationList.subscribed'
        db.delete_column('projects_canvasnotificationlist', 'subscribed')
