...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Action.company'
        db.add_column('projects_action', 'company', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['projects.Company']), keep_default=False)

        # Adding field 'Action.private_action'
        db.add_column('projects_action', 'private_action', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Action.company'
        db.delete_column('projects_action', 'company_id')

        # Deleting field 'Action.private_action'
        db.delete_column('projects_action', 'private_action')
