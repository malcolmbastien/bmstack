...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('projects_invitation', (
        ...
        db.send_create_signal('projects', ['Invitation'])

        # Adding field 'Account.created_at'
        db.add_column('projects_account', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2010, 8, 25), blank=True), keep_default=False)

        # Adding field 'Company.created_at'
        db.add_column('projects_company', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2010, 8, 25), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Invitation'
        db.delete_table('projects_invitation')

        # Deleting field 'Account.created_at'
        db.delete_column('projects_account', 'created_at')

        # Deleting field 'Company.created_at'
        db.delete_column('projects_company', 'created_at')
