...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Company.prime_company'
        db.delete_column('projects_company', 'prime_company')

        # Adding field 'Company.prime'
        db.add_column('projects_company', 'prime', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Company.prime_company'
        db.add_column('projects_company', 'prime_company', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Company.prime'
        db.delete_column('projects_company', 'prime')
    ...
    models = {
        ...
        'projects.action': {
            ...
            'private_action': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'projects.company': {
            ...
            'prime': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'projects.notificationlist': {
            'Meta': {'object_name': 'NotificationList'},
