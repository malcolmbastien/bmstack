...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('projects_company', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True), keep_default=False)

        # Changing field 'Company.address'
        db.alter_column('projects_company', 'address', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Deleting field 'Company.email'
        db.delete_column('projects_company', 'email')

        # Changing field 'Company.address'
        db.alter_column('projects_company', 'address', self.gf('django.db.models.fields.CharField')(max_length=260))
