...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'CanvasNotificationList'
        db.delete_table('projects_canvasnotificationlist')

        # Adding model 'NotificationList'
        db.create_table('projects_notificationlist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('account_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.AccountUser'])),
            ('subscribed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('projects', ['NotificationList'])


    def backwards(self, orm):
        
        # Adding model 'CanvasNotificationList'
        db.create_table('projects_canvasnotificationlist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.AccountUser'])),
            ('subscribed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('canvas_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.CanvasSet'])),
        ))
        db.send_create_signal('projects', ['CanvasNotificationList'])

        # Deleting model 'NotificationList'
        db.delete_table('projects_notificationlist')
